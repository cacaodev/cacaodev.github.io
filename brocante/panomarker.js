...
PanoMarker.prototype.onAdd = function() {
  ...
  var marker = this.newHTMLElement();
  ...
  this.povListener_ = google.maps.event.addListener(this.getMap(),
      'pov_changed', e => { this.draw.bind(this); this.povChanged( this.pano_.getPov() ); });
  this.zoomListener_ = google.maps.event.addListener(this.getMap(),
      'zoom_changed', e => { this.draw.bind(this); this.zoomChanged( this.pano_.getZoom() ); });
